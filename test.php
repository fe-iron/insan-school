                ...
                <tr>
                  <td colspan="2">
                    ...
                    <table class="table table-borderless">
                      ...
                      vertical-align: top;
                      font-size: 13.5px; font-family:'roboto', sans-serif; letter-spacing:1px; font-weight: bold; border-bottom: 1px solid #d2cbcb;">Class Applied For: Shaikshanagar Kishangange </td>

                          <td style="padding: .5rem 1rem;
                      vertical-align: top;
                      font-size: 13.5px; font-family:'roboto', sans-serif; letter-spacing:1px; font-weight: bold; border-bottom: 1px solid #d2cbcb;">Last School TC No: Shaikshanagar Kishangange </td>
                        </tr>
                        <tr>
                      ...
                      font-size: 13.5px; font-family:'roboto', sans-serif; letter-spacing:1px;">Name Of Student</td>
                          <td style="padding: .7rem 1rem .33rem 1rem;
                      vertical-align: top;
                      font-size: 13.5px; font-family:'roboto', sans-serif; letter-spacing:1px;">Shaikshanagar Kishangange </td>
                        </tr>
                        <tr>
                      ...
                      font-size: 13.5px; font-family:'roboto', sans-serif; letter-spacing:1px;">Mother's Tongue</td>
                          <td style="padding: .33rem 1rem;
                      vertical-align: top;
                      font-size: 13.5px; font-family:'roboto', sans-serif; letter-spacing:1px;">
                            <Shaikshanagar Kishangange </td>
                        </tr>
                        <tr>
                          <td style="padding: .33rem 1rem;
                      vertical-align: top;
