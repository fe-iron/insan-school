            ...
            <div class="card-body">
              <form class="m-3">
                <div class="form-group">
                  <label for="exampleInputEmail1">Donar Name <span class="font-weight-bold text-danger">*</span></label>
                  <input type="text" class="form-control" name="name" id="name"  placeholder="Enter Name Here" required="">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Email Id</label>
                  <input type="email" class="form-control" name="email" id="email"  placeholder="Enter Name Here">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Address <span class="font-weight-bold text-danger">*</span></label>
                  <input type="text" class="form-control" name="address" id="address"  placeholder="Enter Name Here" required="">
                </div>
                <div class="form-group">
                ...
                <input class="btn btn-success mt-2" type="button" value="Proceed" name="submit" onclick="donation()"/>
              </form>
            </div>
          </div>
        </div>
