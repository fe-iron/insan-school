  ...
  <section>
    ...
    <div class="sidebar">
      ...
      <div class="" id="sidebar-here">
        ...
        <a href="admission_fee.php" >Admission Fee</a>
        ...
        <a href="donation_list.php" class="active">Donation </a>
      ...
      <div class="col-md-11">
        <div class="card my-5 shadow">
          <nav class="navbar navbar-light  venue-registration border-bottom">
            <a class="h4 text-dark font-weight-bold pt-2">Donation For Poor Student </a>
          </nav>
              ...
              <table class="table table-bordered">
                <thead class="border">
                  <tr>
                    ...
                    <th scope="col" class="border-right text-center">Donor Name</th>
                    <th scope="col" class="border-right text-center">Email</th>
                    <th scope="col" class="border-right text-center">Amount Donated ( INR )</th>
                ...
                <tbody> 
                  ...
                  while($data = mysqli_fetch_assoc($run))
                  {
                    ?> <tr class="border-bottom">
                      ...
                      <td class="border-right text-center"> <?php echo $data['name']; ?> </td>
                      <td class="border-right text-center"> <?php echo $data['email']; ?> </td>
                      ...
                      <td class="border-right text-center"> <?php echo $data['address']; ?> </td>
                      <td class="border-right text-center">
                        <div class="btn-group" role="group" aria-label="Basic example">
                          <a href="donation_delete.php?id=<?php echo $data['sl'];?>" type="submit" class="btn btn-danger">
                            Delete
                          </a>
                        </div>
                      </td>
